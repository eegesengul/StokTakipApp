...
namespace stoktakip.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, stoktakip.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((stoktakip.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public CategoryEntityFactory() : base("CategoryEntity", stoktakip.EntityType.CategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public ProductEntityFactory() : base("ProductEntity", stoktakip.EntityType.ProductEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public StockTransactionEntityFactory() : base("StockTransactionEntity", stoktakip.EntityType.StockTransactionEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(stoktakip.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(stoktakip.EntityType)))
			{
				var factory = GetFactory((stoktakip.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the stoktakip.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(stoktakip.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case stoktakip.EntityType.CategoryEntity:
					return new CategoryEntityFactory();
				case stoktakip.EntityType.ProductEntity:
					return new ProductEntityFactory();
				case stoktakip.EntityType.StockTransactionEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the stoktakip.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (stoktakip.EntityType)Enum.Parse(typeof(stoktakip.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((stoktakip.EntityType)Enum.Parse(typeof(stoktakip.EntityType), leftOperandEntityName, false), joinType, (stoktakip.EntityType)Enum.Parse(typeof(stoktakip.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (stoktakip.EntityType)Enum.Parse(typeof(stoktakip.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((stoktakip.EntityType)entityTypeValue); }
